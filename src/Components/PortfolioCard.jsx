...
const PortfolioCard = ({ imgsrc, title, alt }) => {
  return (
    <div className="relative group overflow-hidden rounded-[10px]">
      ...
      <div className="absolute left-5 bottom-5 w-[230px] bg-[#5956E8] rounded-[10px] py-6 text-center opacity-100 md:opacity-0 translate-y-5 transition-all duration-500 group-hover:opacity-100 group-hover:translate-y-0">
